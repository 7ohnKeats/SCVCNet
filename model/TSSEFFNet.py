...
class WaveletTransform(nn.Module): 
    ...
    """
    def __init__(self, channel, params_path='./model/scaling_filter.mat'):
...
class TS_SEFFNet(nn.Module):
    ...
    def __init__(self,in_chans=22,
        ...
        self.reshape1 = nn.AdaptiveAvgPool2d((1, 159))                                     ######### 69-->159 to match
        ...
        self.SEpooling2 = nn.MaxPool2d(kernel_size = (13, 1),stride = (13, 1))               ####1,3-->13,1
        
        self.elu = nn.ELU(inplace = True)
        
        #the Classifier
        self.conv_classifier=nn.Conv2d(100,self.n_classes,(3, 1),bias=True)                                                    #######9-->27
