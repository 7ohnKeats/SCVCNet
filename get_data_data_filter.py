...
root_eegmat="./filter/eegmat/"
root_stew="./filter/stew/"
root_nback="./filter/nback/"
...
class Datas:
    def __init__(self,root,tag="train"):
        ...
        self.datas=self.datas.reshape(-1,self.datas.shape[2],self.datas.shape[-2],self.datas.shape[-1])
